...
//   event.preventDefault(); // evita el comportamiento por defecto del formulario (enviar por GET o POST)
...
//   `;
//   const mailToLink = `mailto:nicolmarquezok@gmail.com?subject=Solicitud de oración&body=${encodeURIComponent(body)}`;
//   window.location.href = mailToLink;

//   // Muestra un mensaje de confirmación
//   const mensajeForm = document.querySelector('.mensaje-form');
//   mensajeForm.innerHTML = '<p>Gracias por enviar tu solicitud de oración. Estaremos orando por ti.</p>';
// });